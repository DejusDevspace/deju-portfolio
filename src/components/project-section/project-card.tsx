...
export default function ProjectCard({ project }: ProjectCardProps) {
	...
	return (
		<>
			<motion.div
				className="rounded-4xl my-4 p-8 xl:max-w-[31.5%] shadow-xl bg-secondary hover:shadow-lg hover:shadow-neon transition-all duration-300"
				...
				>
					...
					<div className="flex gap-4">
						...
						<div className="flex gap-2">
							{project.links.live !== "#" && (
								<div className="flex justify-center items-center group w-[40px] h-[40px] bg-accent/10 rounded-full cursor-pointer hover:scale-105 transition-all duration-300">
									<a
